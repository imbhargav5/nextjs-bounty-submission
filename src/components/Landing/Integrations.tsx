...
import OrbitingCircles from '../ui/oribiting-circles';
import Chip from '../ui/Chip';

export function OrbitingCirclesDemo() {
  return (
    <div className=" md:scale-110 scale-95 relative flex h-[500px] w-full max-w-[32rem] items-center justify-center overflow-hidden rounded-lg md:dark:shadow-xl">
      <Image alt="nextbase logo" width={100} height={100} src={acmelightLogo} />
...
const Integrations = () => {
  return (
    <div className="w-full min-h-100vh max-h-fit flex flex-col gap-6 mt-20 px-4  pb-24">
